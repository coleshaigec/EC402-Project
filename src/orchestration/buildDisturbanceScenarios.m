    ...
    for i = 1 : numScenariosToBuild
        ...
        switch chosenScenario
            ...
            case 'ladleConstant'
                ...
                currentScenario.channels.dl.parameters.amplitude = 1;
                currentScenario.channels.dn.isActive = false;
                currentScenario.channels.dw.isActive = false;
            case 'ladleStep'
            ...
            case 'nozzlePulse'
                ...
                currentScenario.channels.dn.parameters.amplitude = 0.6;
            ...
            case 'withdrawalConstant'
                ...
                currentScenario.channels.dw.parameters.amplitude = 0.4;
            case 'withdrawalStep'
