function evaluator = buildLinearFullStateClosedLoopEvaluator(linearPlant, controller, disturbanceEvaluator)
    % BUILDLINEARFULLSTATECLOSEDLOOPEVALUATOR Builds utility to evaluate linear closed-loop dynamics for ODE45 under full-state observability.
    % 
