function simulationResult = simulateNonlinearClosedLoopObserver(closedLoopAnalysisPlan)
    % SIMULATENONLINEARCLOSEDLOOPOBSERVER Simulates nonlinear closed-loop dynamics with Luenberger observer.
    %
