function stateFeedbackController = buildStateFeedbackController(linearPlant, stateFeedbackControllerParameters)
    ...
    stateFeedbackController.Acl = [];
    stateFeedbackController.desiredPoles = stateFeedbackControllerParameters.desiredPoles;
    stateFeedbackController.placedPoles = eig(Acl);
    stateFeedbackController.gains = [];
